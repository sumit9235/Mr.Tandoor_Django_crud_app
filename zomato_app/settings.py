"""
Django settings for zomato_app project.
...
SECRET_KEY = 'django-insecure-ce)w-b#r_bj%d*poo1zgmcsbj4%gil3etcu4!r=1!k$#bxw-47'
...
WSGI_APPLICATION = 'zomato_app.wsgi.application'
